...
describe("engine snapshot client", () => {
  ...
  it("accepts the generated checksum-verified human-liver atlas snapshot", async () => {
    ...
    if (result.status === "loaded") {
      ...
      expect(result.summary.evidenceReadiness?.summary.validator_surface_count).toBe(15);
      expect(result.summary.evidenceReadiness?.summary.target_gap_count).toBe(19);
