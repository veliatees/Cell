...
class GluconeogenesisTests(unittest.TestCase):
    def test_fasted_produces_glucose_fed_is_suppressed(self):
        ...
        fed = glucose_output(run_gluconeogenesis(FED, 120.0, EngineRng(21), lactate=6000.0))
        fasted = glucose_output(run_gluconeogenesis(FASTED, 120.0, EngineRng(21), lactate=6000.0))
    ...
    def test_costs_six_atp_per_glucose(self):
        ...
        atp0 = 30000.0
        out = run_gluconeogenesis(FASTED, 120.0, EngineRng(21), lactate=6000.0, atp=atp0)
    ...
    def test_two_carbon3_substrates_per_glucose(self):
        ...
        low = glucose_output(run_gluconeogenesis(FASTED, 120.0, EngineRng(22), lactate=2000.0))
        high = glucose_output(run_gluconeogenesis(FASTED, 120.0, EngineRng(22), lactate=6000.0))
        self.assertAlmostEqual(high, 3000.0, delta=400.0)   # ~lactate/2
    ...
    def test_alanine_is_a_gluconeogenic_substrate(self):
        ...
        out = run_gluconeogenesis(FASTED, 120.0, EngineRng(7), lactate=0.0, alanine=4000.0, nad_pool=8000.0)
        self.assertGreater(glucose_output(out), 500.0)
