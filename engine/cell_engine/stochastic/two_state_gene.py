...
def build_two_state_gene_network(
    ...
    reactions = (
        mass_action("promoter_activation", {"promoter_off": 1}, {"promoter_on": 1},
                    params.k_on_per_s, source_id="telegraph_model", notes="Promoter turns ON."),
        mass_action("promoter_inactivation", {"promoter_on": 1}, {"promoter_off": 1},
                    params.k_off_per_s, source_id="telegraph_model", notes="Promoter turns OFF."),
        mass_action("transcription", {"promoter_on": 1}, {"promoter_on": 1, "mRNA": 1},
                    params.k_transcription_per_s, source_id="telegraph_model", notes="ON-state transcription (bursts)."),
        mass_action("mrna_decay", {"mRNA": 1}, {}, params.k_mrna_decay_per_s,
                    source_id="telegraph_model", notes="mRNA turnover."),
        mass_action("translation", {"mRNA": 1}, {"mRNA": 1, "protein": 1},
                    params.k_translation_per_s, source_id="telegraph_model", notes="Translation."),
        mass_action("protein_decay", {"protein": 1}, {}, params.k_protein_decay_per_s,
                    source_id="telegraph_model", notes="Protein turnover."),
    )
