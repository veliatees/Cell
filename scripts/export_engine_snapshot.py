        ...
        snapshot_to_json(
            ...
            state_extras={
                ...
                "model_authority": {
                    ...
                    "policy": "quantitative_state wins on overlapping species; spatial_world wins on runtime geometry; reaction_authority prevents topology citations or unsupported rates from entering quantitative validation; geometry may change spatial_state but cannot alter biochemistry until a source-backed interaction law passes validation.",
                },
